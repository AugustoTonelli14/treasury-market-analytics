# CLAUDE.md — Treasury Market Analytics Pipeline

> Este ficheiro é o briefing permanente do projeto para o Claude Code.
...
- [ ] Dia 1: Setup repo, estrutura de pastas, README inicial, .env.example, .gitignore, Makefile base
...
**Data:** [PREENCHER NO INÍCIO DE CADA SESSÃO]

**Última coisa feita:**
- Nada ainda — projeto ainda não iniciado.

**Próximo passo — Dia 1:**
1. Criar o repositório `treasury-market-analytics` no GitHub
2. Criar toda a estrutura de pastas (usar `mkdir -p` ou script)
3. Criar `README.md` inicial com overview do projeto
4. Criar `.env.example` com as variáveis necessárias
5. Criar `.gitignore` (Python + DuckDB + .env)
6. Criar `Makefile` com targets base
7. Criar `pyproject.toml` com config do ruff e pytest
8. Criar `requirements.txt` com dependências iniciais
9. Primeiro commit: `feat: initial project structure and setup`
